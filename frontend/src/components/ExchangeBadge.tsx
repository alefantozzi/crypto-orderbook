...
function SimpleIconsHyperliquid(props: SVGProps<SVGSVGElement>) {
  return (
    <svg width="1em" height="1em" viewBox="0 0 144 144" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
